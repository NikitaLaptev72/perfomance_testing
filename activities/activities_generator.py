from activities.methods import get_activities_data
from activities.methods.with_parameters import get_activity_method
from activities.methods.with_parameters import get_confirm_method
from activities.methods.with_body import get_activities_count_method
from activities.methods.with_body import get_entities_activities_dates_method
from activities.methods.with_body import search_activities_method
from activities.methods.with_body_and_parameters import get_activity_fields_values_method
...
def generate_ammo_method(
    ...
    incoming_activities_info = get_activities_data.get_info(
        target,
        currentdir
    )
    ...
    entity = incoming_activities_info[22]
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        future = executor.submit(
            get_entities_activities_dates_method.get_entities_activities_dates,
            entity_id,
            entity,
            count_of_request,
            duration,
        ...
        future = executor.submit(
            get_activity_fields_values_method.get_activity_fields_values,
            activities_id,
            count_of_request,
            duration,
            list_of_ammo
